	...
	implements org.omg.CORBA.portable.InvokeHandler, tpcorba.exo2.calculOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "MiseAZero", new java.lang.Integer(1));
		m_opsHash.put ( "ajouteMemoire", new java.lang.Integer(2));
		m_opsHash.put ( "soustraitMemoire", new java.lang.Integer(3));
		m_opsHash.put ( "decrementer", new java.lang.Integer(4));
		m_opsHash.put ( "multiplieMemoire", new java.lang.Integer(5));
		m_opsHash.put ( "_get_memoire", new java.lang.Integer(6));
